...
def generate_report():
    ...
    try:
        ...
        ax1.set_title("Behavior Layers (Adversarial)")
        ax1.set_ylabel("Rate")
        ax1.set_ylim(0, 1.1)
        ...
        ax2.set_title("Utility (TCR) vs Security (1-ASR)")
        ax2.set_ylabel("Rate")
        ax2.set_ylim(0, 1.1)
        ...
        attack_pivot.plot(kind='bar', ax=plt.gca())
        plt.title("ASR by Attack Type and Defense")
        plt.ylabel("ASR")
        plt.ylim(0, 1.1)
